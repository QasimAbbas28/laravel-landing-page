...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">{{ $g_company_name }}</a>
            </div>
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a style="color: #18bc9c;" href="{{ route('logout') }}"
    ...
    <header>
        <div class="container" id="maincontent" tabindex="-1">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="img/{{ $g_company_logo }}" alt="{{ $g_company_name }}">
                    <div class="intro-text">
                        <h1 class="name">{{ $g_company_name }}</h1>
                        <hr class="star-light">
                        <span class="skills">{{ $g_company_slogan }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; {{ $g_company_name }} 2017
                    </div>
                </div>
            </div>
        </div>
